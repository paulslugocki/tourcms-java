...
public class TourLocationsList {

   private static final Logger logger = Logger.getLogger(TourSearch.class);

   private String path = "/p/tours/locations.xml";
   ...
   TourLocationsList (String mId, String cId, String aKey) {
     marketplaceId = mId;
     channelId = cId;
     apiKey = aKey;

     if(channelId != "0") {
       path = "/c/tours/locations.xml";
     }
   }

   /**
    * Call the Tour CMS Search Tours API https://www.tourcms.com/support/api/mp/locations_list.php
    * @param qParams NameValuePair of parameters to send to the API
    * @return XML response from TourCMS.
    * @throws Exception
    */

   public String listTourLocations(List<NameValuePair> qParams)throws Exception {
